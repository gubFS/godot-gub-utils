...
func on_changed(callable : Callable, connection_id: int = -1) -> int:
...
func on_changed_bidirectional(callable: Callable, bidirectional_signal: Signal, bidirectional_callable: Callable, connection_id: int = -1) -> int:
...
func bind(obj: Object, property: String, connection_id: int = -1) -> int:
	var bind_callable: Callable = func(value_: Variant) -> void:
		obj.set(property, value_)
	return on_changed(bind_callable, connection_id)
...
func bind_bidirectional(obj: Object, property: String, on_set_signal: Signal, connection_id: int = -1) -> int:
	var bind_callable: Callable = func(value_: Variant) -> void:
		obj.set(property, value_)
